...
rm -rf feeds/custom/mt-drivers/mt7615d
svn co https://github.com/immortalwrt/immortalwrt/branches/master/package/kernel/mt-drivers/mt7615d package/feeds/custom/mt-drivers/mt7615d
